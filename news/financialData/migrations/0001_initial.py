# Generated by Django 3.2.13 on 2023-10-02 06:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('seq', models.AutoField(primary_key=True, serialize=False)),
                ('stability', models.IntegerField(default=0, null=True)),
                ('size', models.IntegerField(default=0, null=True)),
                ('growth', models.IntegerField(default=0, null=True)),
                ('profitability', models.IntegerField(default=0, null=True)),
                ('revenue_growth', models.IntegerField(default=0, null=True)),
                ('operating_profit_growth', models.IntegerField(default=0, null=True)),
                ('company_seq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Company_indicators_score', to='financialData.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('seq', models.AutoField(primary_key=True, serialize=False)),
                ('stability', models.FloatField(default=None, null=True)),
                ('size', models.BigIntegerField(default=None, null=True)),
                ('growth', models.FloatField(default=None, null=True)),
                ('profitability', models.FloatField(default=None, null=True)),
                ('revenue_growth', models.FloatField(default=None, null=True)),
                ('operating_profit_growth', models.FloatField(default=None, null=True)),
                ('company_seq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Company_indicators', to='financialData.company')),
            ],
        ),
    ]
