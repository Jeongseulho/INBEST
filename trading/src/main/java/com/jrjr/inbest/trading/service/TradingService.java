...
public class TradingService {
	...
	public void sellStock(TradingDTO tradingDTO) throws Exception {
		...
		redisSimulationUserDTO.setCurrentMoney(
			redisSimulationUserDTO.getCurrentMoney() + tradingDTO.getPrice() * tradingDTO.getAmount());
		simulationUserHashOperations.put(simulationHashKey, String.valueOf(redisSimulationUserDTO.getUserSeq()),
