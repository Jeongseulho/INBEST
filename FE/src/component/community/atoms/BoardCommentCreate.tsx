...
const BoardCommentCreate = ({ setCommentText, onPostComment, commentText, commentSeq }: CommentProps) => {
  const { userInfo } = userStore();
  return (
    <>
      <div className="flex items-start relative mx-10 my-8">
        ...
        <div className="flex justify-center items-center absolute right-3 bottom-3">
          <button className="me-5 text-red-500">취소</button>
